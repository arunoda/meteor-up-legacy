...
var settingsFile = cliOptions.settings || 'settings.json';
var configFile = cliOptions.config || 'mup.json';
...
function Actions(config, cwd) {
  ...
  //get settingsFile into env
  var setttingsJsonPath = path.resolve(this.cwd, settingsFile);
...
Actions.init = function() {
  var destMupJson = path.resolve(configFile);
  var destSettingsJson = path.resolve(settingsFile);
