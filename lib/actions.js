...
function Actions(config, cwd) {
  ...
  var setttingsJsonPath = path.resolve(this.cwd, settingsFileName);
...
Actions.init = function() {
  var destMupJson = path.resolve(configFileName);
  var destSettingsJson = path.resolve(settingsFileName);
