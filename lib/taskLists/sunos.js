...
exports.restart = function(env, appName) {
...
exports.stop = function(env, appName) {
...
exports.start = function(env, appName) {
...
exports.reset = function(env, appName) {
  var taskList = nodemiral.taskList("Resetting Application State (sunos)");

  //starting
  taskList.execute('Dropping Database "'+appName+'"', {
    command: '(mongo ' + appName + ' --eval "db.dropDatabase()")'
  });
