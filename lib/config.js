...
exports.read = function() {
  var mupJsonPath = path.resolve(configFile);
  if(fs.existsSync(mupJsonPath)) {
    ...
    console.error('configuration file ' + configFile + ' does not exist!'.red.bold);
    helpers.printHelp();
    process.exit(1);
  }
};
...
function mupErrorLog(message) {
  var errorMessage = 'Invalid configuration file ' + configFile + ': ' + message;
